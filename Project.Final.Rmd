...
In order to perform t-tests with our data we needed to first check for normality and outliers in our data. All fluxes went through log transformations. C-flux boxplot means do not overlap and box sizes for 150, 200, and 300 seem to be similar in box size as well as whisker length which means that they could be good predictors of each other and do not break homoscedasticity. However, the 400 depth has a lot of overlap with the other fluxes and a very different shape which could break homoscedasticity (Fig 9-16). N-flux boxplot means do not too seem to overlap too much for 150 and 200, but there is a bit of overlap in 200 and 300. 150, 200, and 300 seem to be similar in box size as well as whisker length which means that they could be good predictors of each other and do not break homoscedasticity. However, the 400 depth has a lot of overlap and a very different shape which could break homoscedasticity (Fig 21-28). For P-flux, boxplot means seem to have some overlap. They are similar in box size, but the concern is the overlap, making them not good predictors of one another and potentially breaking homoscedasticity (Fig 32-37). For M-flux, boxplot means seem to have some overlap. They are similar in box size, but the concern is the overlap, making them not good predictors of one another and potentially breaking homoscedasticity (Fig 42-49). 
