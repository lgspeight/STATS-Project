...
*See Appendix ii for distributional hitrograms and log tranformation histograms*
...
*boxplot means overlap, but box sizes for 150, 200, 300, and 400 seem to be similar in box size as well as whisker length which means that they could be good predictors of each other. However, the concern is the overlap suggesting that they break homoscedasticity and are not good predictors of one another.*
...
*boxplot means seem to overlap a bit for 150, 200, 300, and 400. The 400 depth has a lot of overlap and a very different shape and whiskers. All of these observations suggest that the model breaks homosedasticity and that the depths are not good good predictors of one another*
...
*boxplot means seem to overlap a for 150, 200, and 300. Even though they are similar in box and whisker length, the overlap suggests that the model breaks homosedasticity and that the depths are not good good predictors of one another*
...
*boxplot means seem to have some overlap. They are similar in box size except for 400, but the concern is the overlap, making them not good predictors of one another and potentially breaking homosedasticity. Conclusively, depths are not good predictors of one another and will no be used in our results*
