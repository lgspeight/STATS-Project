...
Creating $\overline{D}$ for each paired group
...
hist(log(C.depth.150.200$D_bar), breaks = "FD", main ="Fig 50 C.depth.150.200$D_bar") #try lo transform 
boxplot(log(C.depth.150.200$D_bar)) #lots of outliers 

par(mfrow=c(1,3))
hist(C.depth.200.300$D_bar, breaks = "FD")
hist(log(C.depth.200.300$D_bar), breaks = "FD", main ="Fig 51 C.depth.200.300$D_bar") #try lo transform 
boxplot(log(C.depth.200.300$D_bar)) #lots of outliers 

# Nitrogen
par(mfrow=c(1,3))
hist(N.depth.150.200$D_bar, breaks = "FD")
hist(log(N.depth.150.200$D_bar), breaks = "FD", main ="Fig 52 N.depth.150.200$D_bar") #try lo transform 
boxplot(log(N.depth.150.200$D_bar)) #lots of outliers 

par(mfrow=c(1,3))
hist(N.depth.200.300$D_bar, breaks = "FD")
hist(log(N.depth.200.300$D_bar), breaks = "FD", main ="Fig 53 N.depth.200.300$D_bar") #try lo transform 
boxplot(log(N.depth.200.300$D_bar)) #lots of outliers 

# Phosphorous
par(mfrow=c(1,3))
hist(P.depth.150.200$D_bar, breaks = "FD")
hist(log(P.depth.150.200$D_bar), breaks = "FD", main ="Fig 54 P.depth.150.200$D_bar") #try lo transform 
boxplot(log(P.depth.150.200$D_bar)) #lots of outliers 

par(mfrow=c(1,3))
hist(P.depth.200.300$D_bar, breaks = "FD")
hist(log(P.depth.200.300$D_bar), breaks = "FD", main ="Fig 55 P.depth.200.300$D_bar") #try lo transform 
boxplot(log(P.depth.200.300$D_bar)) #lots of outliers 

# Mass 
par(mfrow=c(1,3))
hist(M.depth.150.200$D_bar, breaks = "FD")
hist(log(M.depth.150.200$D_bar), breaks = "FD", main ="Fig 56 M.depth.150.200$D_bar") #try lo transform 
boxplot(log(M.depth.150.200$D_bar)) #lots of outliers 

par(mfrow=c(1,3))
hist(M.depth.200.300$D_bar, breaks = "FD")
hist(log(M.depth.200.300$D_bar), breaks = "FD", main ="Fig 57 C.depth.200.300$D_bar") #try lo transform 
...
*There is no significance difference in the first anova model*
